...
![image of black star](img/fullstar.png) ![image of black star](img/fullstar.png) ![image of black star](img/halfstar.png)
Maggie Ark
...
There are not many weaknesses for users of LitLift.com. The only slightly annoying thing is that the login process is somewhat difficult. Luckily, users can sign up for LitLift through Facebook or Twitter, which allows for easier access to the site.
...
## Specimen 3: Yarny
![image of book and pen](img/novelwriting.png)
![image of paper and magnafying lens](img/research.png)
